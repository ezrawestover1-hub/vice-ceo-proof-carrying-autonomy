...
<body>
  <div class="shell">
    ...
    <main><header class="topbar"><div class="office">Vice CEO · Business Autonomy</div><nav aria-label="Page sections"><a href="#review">Review</a><a href="#evidence">Evidence</a></nav></header><div class="document">
      <article class="content" id="review"><a class="back" href="/demo/judge-flow">&larr; View the five-act proof flow</a><h1>Less busywork.<br>Better <em>decisions.</em></h1><p class="lede">Vice CEO handles the repetitive checking and research that keeps a business from moving forward. When something needs attention, it brings you a clear, evidence-backed next step while you stay in control.</p><dl class="case-meta"><dt>Product</dt><dd>Proof-carrying business autonomy</dd><dt>Demo workflow</dt><dd>Synthetic support escalation</dd><dt>Live deployment example</dt><dd>Westover EPR Registry Change Watch</dd><dt>Authority</dt><dd class="ok">No external business tools</dd><dt>Release state</dt><dd>{escape(deployment_status)} · provider {escape(provider_status).lower()}</dd></dl>
