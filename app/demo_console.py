...
<body>
  <div class="shell">
    ...
    <main><header class="topbar"><div class="office">Vice CEO · Business Autonomy</div><nav aria-label="Page sections"><a href="#review">Review</a><a href="#evidence">Evidence</a></nav></header><div class="document">
      <article class="content" id="review"><a class="back" href="/demo/judge-flow">&larr; View the five-act proof flow</a><h1>From signal<br>to a <em>business decision.</em></h1><p class="lede">Vice CEO turns an operational signal into an evidence-backed, authority-bounded decision a business can review, replay, and trust.</p><dl class="case-meta"><dt>Product</dt><dd>Proof-carrying business autonomy</dd><dt>Demo workflow</dt><dd>Synthetic support escalation</dd><dt>Live deployment example</dt><dd>Westover EPR Registry Change Watch</dd><dt>Authority</dt><dd class="ok">No external business tools</dd><dt>Release state</dt><dd>{escape(deployment_status)} · provider {escape(provider_status).lower()}</dd></dl>
